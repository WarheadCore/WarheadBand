...
public:
    ...
    void OnBeforeCreateInstanceScript(InstanceMap* instanceMap, [[maybe_unused]] InstanceScript* instanceData, bool /*load*/, std::string /*data*/, uint32 /*completedEncounterMask*/) override
    {
