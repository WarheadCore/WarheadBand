...
public:
    ...
    void OnRemoveMember(Guild* guild, Player* player, bool /*isDisbanding*/, bool /*isKicked*/) override
    {
        ...
        sGuildLevelSystem->RescaleCriterias(guildID);
        sGuildLevelSystem->UnLearnSpellsForPlayer(player->GetGUID(), guildID);
    }
};
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action) override
    {
        ...
        {
            case 1:
                AddGossipItemFor(player, 10, Warhead::StringFormat("> Количество участников {}", player->GetGuild()->GetMemberCount()), GOSSIP_SENDER_MAIN, 1);
