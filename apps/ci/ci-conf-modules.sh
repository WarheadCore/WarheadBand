...
CSCRIPTS=dynamic
CMODULES=dynamic
CAPPS_BUILD=world-only
CCUSTOMOPTIONS='-DWITH_DYNAMIC_LINKING=1 -DCMAKE_C_COMPILER_LAUNCHER=ccache -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_C_FLAGS="-Werror" -DCMAKE_CXX_FLAGS="-Werror"'
