...
using NodeDatabasePreparedStatement = PreparedStatement<NodeDatabaseConnection>;
...
using NodeDatabaseTransaction = SQLTransaction<NodeDatabaseConnection>;
...
using NodeDatabaseQueryHolder = SQLQueryHolder<NodeDatabaseConnection>;
