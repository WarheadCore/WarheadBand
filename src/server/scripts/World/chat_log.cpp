...
public:
  ...
  void OnChat(Player *player, uint32 type, uint32 lang,
    ...
    case CHAT_MSG_EMOTE:
      LOG_CHAT("emote", "Player %s emotes: %s", player->GetName().c_str(),
               msg.c_str());
      break;
  ...
  void OnChat(Player *player, uint32 /*type*/, uint32 lang, std::string &msg,
    ...
    LOG_CHAT("whisper", "Player %s tells %s: %s", player->GetName().c_str(),
             receiver ? receiver->GetName().c_str() : "<unknown>", msg.c_str());
  }
  ...
  void OnChat(Player *player, uint32 type, uint32 lang, std::string &msg,
    ...
    case CHAT_MSG_PARTY:
      LOG_CHAT("party", "Player %s tells group with leader %s: %s",
               ...
               group ? group->GetLeaderName() : "<unknown>", msg.c_str());
      break;

    case CHAT_MSG_PARTY_LEADER:
      LOG_CHAT("party", "Leader %s tells group: %s", player->GetName().c_str(),
               msg.c_str());
      break;
  ...
  void OnChat(Player *player, uint32 type, uint32 lang, std::string &msg,
    ...
    case CHAT_MSG_GUILD:
      LOG_CHAT("guild", "Player %s tells guild %s: %s",
               player->GetName().c_str(),
               guild ? guild->GetName().c_str() : "<unknown>", msg.c_str());
      break;
  ...
  void OnChat(Player *player, uint32 /*type*/, uint32 lang, std::string &msg,
    ...
    if (isSystem) {
      LOG_CHAT("system", "Player %s tells channel %s: %s",
               player->GetName().c_str(), channel->GetName().c_str(),
               msg.c_str());
    } else {
