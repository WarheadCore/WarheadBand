...
public:
  ...
  std::vector<ChatCommand> GetCommands() const override {
    static std::vector<ChatCommand> reloadAllCommandTable = {
        {"achievement", SEC_ADMINISTRATOR, true,
    ...
    static std::vector<ChatCommand> reloadCommandTable = {
        ...
        {"areatrigger", SEC_ADMINISTRATOR, true,
         &HandleReloadAreaTriggerCommand, ""},
        {"areatrigger_involvedrelation", SEC_ADMINISTRATOR, true,
        ...
        {"broadcast_text", SEC_ADMINISTRATOR, true,
         &HandleReloadBroadcastTextCommand, ""},
        {"battleground_template", SEC_ADMINISTRATOR, true,
        ...
        {"creature_text", SEC_ADMINISTRATOR, true, &HandleReloadCreatureText,
         ""},
        {"creature_questender", SEC_ADMINISTRATOR, true,
        ...
        {"creature_queststarter", SEC_ADMINISTRATOR, true,
        ...
        {"achievement_reward_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesAchievementRewardCommand, ""},
        {"creature_template_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesCreatureCommand, ""},
        {"creature_text_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesCreatureTextCommand, ""},
        {"gameobject_template_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesGameobjectCommand, ""},
        {"gossip_menu_option_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesGossipMenuOptionCommand, ""},
        {"item_template_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesItemCommand, ""},
        {"item_set_name_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesItemSetNameCommand, ""},
        {"npc_text_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesNpcTextCommand, ""},
        {"page_text_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesPageTextCommand, ""},
        {"points_of_interest_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesPointsOfInterestCommand, ""},
        {"quest_template_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesQuestCommand, ""},
        {"quest_offer_reward_locale", SEC_ADMINISTRATOR, true,
         &HandleReloadLocalesQuestOfferRewardCommand, ""},
        {"quest_request_item_locale", SEC_ADMINISTRATOR, true,
        ...
        {"spell_target_position", SEC_ADMINISTRATOR, true,
         &HandleReloadSpellTargetPositionCommand, ""},
        {"spell_threats", SEC_ADMINISTRATOR, true,
         &HandleReloadSpellThreatsCommand, ""},
        {"spell_group_stack_rules", SEC_ADMINISTRATOR, true,
         &HandleReloadSpellGroupStackRulesCommand, ""},
        {"acore_string", SEC_ADMINISTRATOR, true,
         &HandleReloadAcoreStringCommand, ""},
        {"warden_action", SEC_ADMINISTRATOR, true,
        ...
        {"vehicle_accessory", SEC_ADMINISTRATOR, true,
         &HandleReloadVehicleAccessoryCommand, ""},
        {"vehicle_template_accessory", SEC_ADMINISTRATOR, true,
  ...
  static bool
  HandleReloadAchievementCriteriaDataCommand(ChatHandler *handler,
                                             const char * /*args*/) {
  ...
  static bool HandleReloadCreatureTemplateCommand(ChatHandler *handler,
    ...
    for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end();
         ++itr) {
  ...
  static bool HandleReloadQuestAreaTriggersCommand(ChatHandler *handler,
    ...
    handler->SendGlobalGMSysMessage("DB table `areatrigger_involvedrelation` "
                                    "(quest area triggers) reloaded.");
    return true;
  }
  ...
  static bool
  HandleReloadLootTemplatesDisenchantCommand(ChatHandler *handler,
                                             const char * /*args*/) {
    LOG_INFO("server",
  ...
  static bool
  HandleReloadLootTemplatesGameobjectCommand(ChatHandler *handler,
                                             const char * /*args*/) {
    LOG_INFO("server",
  ...
  static bool HandleReloadWardenactionCommand(ChatHandler *handler,
    ...
    if (!sWorld->getBoolConfig(CONFIG_WARDEN_ENABLED)) {
      handler->SendSysMessage("Warden system disabled by config - reloading "
                              "warden_action skipped.");
      handler->SetSentErrorMessage(true);
      return false;
    }
  ...
  HandleReloadSkillPerfectItemTemplateCommand(ChatHandler *handler,
                                              const char * /*args*/) {
    // latched onto HandleReloadSkillExtraItemTemplateCommand as it's part of
    // that table group (and i don't want to chance all the command IDs)
  ...
  static bool HandleReloadSpellAreaCommand(ChatHandler *handler,
    ...
    handler->SendGlobalGMSysMessage("DB table `spell_area` (spell dependences "
                                    "from area/quest/auras state) reloaded.");
    return true;
  }
  ...
  static bool HandleReloadSpellProcEventCommand(ChatHandler *handler,
    ...
    handler->SendGlobalGMSysMessage("DB table `spell_proc_event` (spell proc "
                                    "trigger requirements) reloaded.");
    return true;
  }
  ...
  static bool HandleReloadSpellBonusesCommand(ChatHandler *handler,
    ...
    handler->SendGlobalGMSysMessage("DB table `spell_bonus_data` (spell "
                                    "damage/healing coefficients) reloaded.");
    return true;
  }
  ...
  static bool HandleReloadSpellGroupStackRulesCommand(ChatHandler *handler,
    ...
    handler->SendGlobalGMSysMessage("DB table `spell_group_stack_rules` (spell "
                                    "stacking definitions) reloaded.");
    return true;
  }
  ...
  static bool HandleReloadPageTextsCommand(ChatHandler *handler,
    ...
    handler->GetSession()->SendNotification(
        "You need to delete your client cache or change the cache number in "
        "config in order for your players see the changes.");
    return true;
  }
  ...
  static bool
  HandleReloadLocalesGossipMenuOptionCommand(ChatHandler *handler,
                                             const char * /*args*/) {
  ...
  static bool
  HandleReloadLocalesPointsOfInterestCommand(ChatHandler *handler,
                                             const char * /*args*/) {
  ...
  static bool
  HandleReloadLocalesQuestOfferRewardCommand(ChatHandler *handler,
                                             char const * /*args*/) {
