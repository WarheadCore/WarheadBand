...
public:
    ...
    static bool HandleModifyHPCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_HP, handler->GetNameLink(target), hp, hpm);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_HP_CHANGED, handler->GetNameLink(), hp, hpm);
    ...
    static bool HandleModifyManaCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_MANA, handler->GetNameLink(target), mana, manam);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_MANA_CHANGED, handler->GetNameLink(), mana, manam);
    ...
    static bool HandleModifyEnergyCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_ENERGY, handler->GetNameLink(target), energy / 10, energym / 10);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_ENERGY_CHANGED, handler->GetNameLink(), energy / 10, energym / 10);
    ...
    static bool HandleModifyRageCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_RAGE, handler->GetNameLink(target), rage / 10, ragem / 10);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_RAGE_CHANGED, handler->GetNameLink(), rage / 10, ragem / 10);
    ...
    static bool HandleModifyRunicPowerCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_RUNIC_POWER, handler->GetNameLink(target), rune / 10, runem / 10);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_RUNIC_POWER_CHANGED, handler->GetNameLink(), rune / 10, runem / 10);
    ...
    static bool HandleModifyASpeedCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            handler->PSendSysMessage(LANG_CHAR_IN_FLIGHT, targetNameLink);
            handler->SetSentErrorMessage(true);
            return false;
        }

        handler->PSendSysMessage(LANG_YOU_CHANGE_ASPEED, ASpeed, targetNameLink);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_ASPEED_CHANGED, handler->GetNameLink(), ASpeed);
    ...
    static bool HandleModifySpeedCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_SPEED, Speed, targetNameLink);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_SPEED_CHANGED, handler->GetNameLink(), Speed);
    ...
    static bool HandleModifySwimCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_SWIM_SPEED, Swim, targetNameLink);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_SWIM_SPEED_CHANGED, handler->GetNameLink(), Swim);
    ...
    static bool HandleModifyBWalkCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_BACK_SPEED, BSpeed, targetNameLink);
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_BACK_SPEED_CHANGED, handler->GetNameLink(), BSpeed);
    ...
    static bool HandleModifyFlyCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_CHANGE_FLY_SPEED, FSpeed, handler->GetNameLink(target));
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_YOURS_FLY_SPEED_CHANGED, handler->GetNameLink(), FSpeed);
    ...
    static bool HandleModifyMountCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_YOU_GIVE_MOUNT, handler->GetNameLink(target));
        if (handler->needReportToTarget(target))
            (ChatHandler(target->GetSession())).PSendSysMessage(LANG_MOUNT_GIVED, handler->GetNameLink());
