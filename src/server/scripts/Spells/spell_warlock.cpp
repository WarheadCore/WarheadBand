  ...
  class spell_warl_eye_of_kilrogg_AuraScript : public AuraScript {
    ...
    void Register() override {
      OnEffectApply += AuraEffectApplyFn(
          spell_warl_eye_of_kilrogg_AuraScript::HandleAuraApply, EFFECT_1,
          SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
      AfterEffectRemove += AuraEffectRemoveFn(
          spell_warl_eye_of_kilrogg_AuraScript::HandleAuraRemove, EFFECT_1,
          SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    }
  };
...
public:
  ...
  class spell_warl_shadowflame_SpellScript : public SpellScript {
    ...
    void Register() override {
      OnEffectHitTarget +=
          SpellEffectFn(spell_warl_shadowflame_SpellScript::HandleSchoolDMG,
...
public:
  ...
  class spell_warl_seduction_AuraScript : public AuraScript {
    ...
    void Register() override {
      OnEffectApply += AuraEffectApplyFn(
          spell_warl_seduction_AuraScript::HandleAuraApply, EFFECT_0,
...
public:
  ...
  class spell_warl_improved_demonic_tactics_AuraScript : public AuraScript {
    ...
    void CalcPeriodic(AuraEffect const * /*aurEff*/, bool &isPeriodic,
                      int32 &amplitude) {
      isPeriodic = true;
      ...
      if (aurEff->GetEffIndex() == EFFECT_0)
        amount = CalculatePct<int32, float>(
            GetUnitOwner()->ToPlayer()->GetFloatValue(
                PLAYER_SPELL_CRIT_PERCENTAGE1 + SPELL_SCHOOL_FROST),
            GetSpellInfo()->Effects[EFFECT_0].CalcValue());
      else
        amount = CalculatePct<int32, float>(
            GetUnitOwner()->ToPlayer()->GetFloatValue(PLAYER_CRIT_PERCENTAGE),
            GetSpellInfo()->Effects[EFFECT_0].CalcValue());
    }
    ...
    void Register() override {
      DoEffectCalcPeriodic += AuraEffectCalcPeriodicFn(
          spell_warl_improved_demonic_tactics_AuraScript::CalcPeriodic,
          EFFECT_ALL, SPELL_AURA_DUMMY);
      DoEffectCalcAmount += AuraEffectCalcAmountFn(
          spell_warl_improved_demonic_tactics_AuraScript::CalculateAmount,
          EFFECT_ALL, SPELL_AURA_DUMMY);
      ...
      OnEffectPeriodic += AuraEffectPeriodicFn(
          spell_warl_improved_demonic_tactics_AuraScript::HandlePeriodic,
          EFFECT_ALL, SPELL_AURA_DUMMY);
    }
  };
  ...
  class spell_warl_ritual_of_summoning_SpellScript : public SpellScript {
    ...
    void Register() override {
      OnCheckCast += SpellCheckCastFn(
          spell_warl_ritual_of_summoning_SpellScript::CheckCast);
    }
  };
...
public:
  ...
  class spell_warl_demonic_aegis_AuraScript : public AuraScript {
    ...
    void HandleAuraApply(AuraEffect const * /*aurEff*/,
      ...
      GetTarget()->RemoveAurasWithFamily(SPELLFAMILY_WARLOCK, 0, 0x20000020, 0,
                                         0);
    }

    void Register() override {
      OnEffectRemove += AuraEffectRemoveFn(
          spell_warl_demonic_aegis_AuraScript::HandleAuraApply, EFFECT_0,
...
public:
  ...
  class spell_warl_demonic_knowledge_AuraScript : public AuraScript {
    ...
    void Register() override {
      DoEffectCalcAmount += AuraEffectCalcAmountFn(
          spell_warl_demonic_knowledge_AuraScript::CalculateAmount, EFFECT_0,
          SPELL_AURA_MOD_DAMAGE_DONE);
      DoEffectCalcPeriodic += AuraEffectCalcPeriodicFn(
          spell_warl_demonic_knowledge_AuraScript::CalcPeriodic, EFFECT_0,
          SPELL_AURA_MOD_DAMAGE_DONE);
      OnEffectPeriodic += AuraEffectPeriodicFn(
          spell_warl_demonic_knowledge_AuraScript::HandlePeriodic, EFFECT_0,
          SPELL_AURA_MOD_DAMAGE_DONE);
    }
  };
...
public:
  ...
  class spell_warl_generic_scaling_AuraScript : public AuraScript {
    ...
    void CalculateResistanceAmount(AuraEffect const *aurEff, int32 &amount,
                                   bool & /*canBeRecalculated*/) {
    ...
    void CalculateStatAmount(AuraEffect const *aurEff, int32 &amount,
                             bool & /*canBeRecalculated*/) {
      ...
      if (Unit *owner = GetUnitOwner()->GetOwner()) {
        ...
        amount =
            CalculatePct(std::max<int32>(0, owner->GetStat(stat)), modifier);
      }
    }

    void CalculateAPAmount(AuraEffect const * /*aurEff*/, int32 &amount,
                           bool & /*canBeRecalculated*/) {
    ...
    void CalculateSPAmount(AuraEffect const * /*aurEff*/, int32 &amount,
                           bool & /*canBeRecalculated*/) {
      ...
      if (aurEff->GetAuraType() == SPELL_AURA_MOD_STAT &&
        ...
        if (newAmount != currentAmount) {
          if (aurEff->GetMiscValue() == STAT_STAMINA) {
            ...
            GetUnitOwner()->SetHealth(
                std::min<uint32>(GetUnitOwner()->GetMaxHealth(), actStat));
          } else {
            uint32 actStat = GetUnitOwner()->GetPower(POWER_MANA);
            GetEffect(aurEff->GetEffIndex())->ChangeAmount(newAmount, false);
            GetUnitOwner()->SetPower(
                POWER_MANA,
                std::min<uint32>(GetUnitOwner()->GetMaxPower(POWER_MANA),
                                 actStat));
          }
        }
      } else
    ...
    void Register() override {
      if (m_scriptSpellId != 34947)
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_generic_scaling_AuraScript::CalculateResistanceAmount,
            EFFECT_ALL, SPELL_AURA_MOD_RESISTANCE);

      if (m_scriptSpellId == 34947 || m_scriptSpellId == 34956)
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_generic_scaling_AuraScript::CalculateStatAmount,
            EFFECT_ALL, SPELL_AURA_MOD_STAT);

      if (m_scriptSpellId == 34947) {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_generic_scaling_AuraScript::CalculateAPAmount,
            EFFECT_ALL, SPELL_AURA_MOD_ATTACK_POWER);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_generic_scaling_AuraScript::CalculateSPAmount,
            EFFECT_ALL, SPELL_AURA_MOD_DAMAGE_DONE);
      }

      DoEffectCalcPeriodic += AuraEffectCalcPeriodicFn(
          spell_warl_generic_scaling_AuraScript::CalcPeriodic, EFFECT_ALL,
          SPELL_AURA_ANY);
      OnEffectPeriodic += AuraEffectPeriodicFn(
          spell_warl_generic_scaling_AuraScript::HandlePeriodic, EFFECT_ALL,
          SPELL_AURA_ANY);
    }
  };
...
public:
  ...
  class spell_warl_infernal_scaling_AuraScript : public AuraScript {
    ...
    void HandleEffectApply(AuraEffect const *aurEff,
                           AuraEffectHandleModes /*mode*/) {
      GetUnitOwner()->ApplySpellImmune(0, IMMUNITY_STATE, aurEff->GetAuraType(),
                                       true, SPELL_BLOCK_TYPE_POSITIVE);
      if (aurEff->GetAuraType() == SPELL_AURA_MOD_ATTACK_POWER)
        GetUnitOwner()->ApplySpellImmune(0, IMMUNITY_STATE,
                                         SPELL_AURA_MOD_ATTACK_POWER_PCT, true,
    ...
    void Register() override {
      if (m_scriptSpellId != 36186)
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_infernal_scaling_AuraScript::CalculateResistanceAmount,
            EFFECT_ALL, SPELL_AURA_MOD_RESISTANCE);

      if (m_scriptSpellId == 36186 || m_scriptSpellId == 36188)
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_infernal_scaling_AuraScript::CalculateStatAmount,
            EFFECT_ALL, SPELL_AURA_MOD_STAT);

      if (m_scriptSpellId == 36186) {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_infernal_scaling_AuraScript::CalculateAPAmount,
            EFFECT_ALL, SPELL_AURA_MOD_ATTACK_POWER);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_warl_infernal_scaling_AuraScript::CalculateSPAmount,
            EFFECT_ALL, SPELL_AURA_MOD_DAMAGE_DONE);
      }

      OnEffectApply += AuraEffectApplyFn(
          spell_warl_infernal_scaling_AuraScript::HandleEffectApply, EFFECT_ALL,
...
public:
  ...
  class spell_warl_banish_SpellScript : public SpellScript {
    ...
    void HandleBanish() {
      if (Unit *target = GetHitUnit()) {
        if (target->GetAuraEffect(SPELL_AURA_SCHOOL_IMMUNITY,
                                  SPELLFAMILY_WARLOCK, 0, 0x08000000, 0)) {
          // No need to remove old aura since its removed due to not stack by
          // current Banish aura
  ...
  class spell_warl_demonic_empowerment_SpellScript : public SpellScript {
        ...
        if (targetCreature->IsPet()) {
          ...
          case CREATURE_FAMILY_SUCCUBUS:
            targetCreature->CastSpell(
                targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_SUCCUBUS,
                true);
            break;
          case CREATURE_FAMILY_VOIDWALKER: {
            ...
            int32 hp = int32(targetCreature->CountPctFromMaxHealth(
                GetCaster()->CalculateSpellDamage(targetCreature, spellInfo,
                                                  0)));
            targetCreature->CastCustomSpell(
                targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_VOIDWALKER,
          ...
          case CREATURE_FAMILY_FELGUARD:
            targetCreature->CastSpell(
                targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_FELGUARD,
                true);
            break;
          case CREATURE_FAMILY_FELHUNTER:
            targetCreature->CastSpell(
                targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_FELHUNTER,
                true);
            break;
          case CREATURE_FAMILY_IMP:
            targetCreature->CastSpell(
                targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_IMP, true);
            break;
          }
        }
      }
    ...
    void Register() override {
      OnEffectHitTarget += SpellEffectFn(
          spell_warl_demonic_empowerment_SpellScript::HandleScriptEffect,
  ...
  class spell_warl_create_healthstone_SpellScript : public SpellScript {
    ...
    SpellCastResult CheckCast() {
      if (Player *caster = GetCaster()->ToPlayer()) {
        ...
        InventoryResult msg = caster->CanStoreNewItem(
            NULL_BAG, NULL_SLOT, dest, iTypes[spellRank - 1][0], 1, nullptr);
        if (msg != EQUIP_ERR_OK)
    ...
    void HandleScriptEffect(SpellEffIndex effIndex) {
      if (Unit *unitTarget = GetHitUnit()) {
        ...
        if (AuraEffect const *aurEff =
                unitTarget->GetDummyAuraEffect(SPELLFAMILY_WARLOCK, 284, 0)) {
          switch (aurEff->GetId()) {
          ...
          case SPELL_WARLOCK_IMPROVED_HEALTHSTONE_R2:
            ...
            break;
          default:
            LOG_ERROR("server", "Unknown rank of Improved Healthstone id: %d",
                      aurEff->GetId());
            break;
          }
        }
    ...
    void Register() override {
      OnEffectHitTarget += SpellEffectFn(
          spell_warl_create_healthstone_SpellScript::HandleScriptEffect,
          EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
      OnCheckCast += SpellCheckCastFn(
          spell_warl_create_healthstone_SpellScript::CheckCast);
    }
  };
...
uint32 const spell_warl_create_healthstone::
    spell_warl_create_healthstone_SpellScript::iTypes[8][3] = {
...
public:
  ...
  class spell_warl_everlasting_affliction_SpellScript : public SpellScript {
    ...
    void HandleScriptEffect(SpellEffIndex /*effIndex*/) {
      if (Unit *unitTarget = GetHitUnit())
        ...
        if (AuraEffect *aur = unitTarget->GetAuraEffect(
                SPELL_AURA_PERIODIC_DAMAGE, SPELLFAMILY_WARLOCK, 0x2, 0, 0,
                GetCaster()->GetGUID())) {
    ...
    void Register() override {
      OnEffectHitTarget += SpellEffectFn(
          spell_warl_everlasting_affliction_SpellScript::HandleScriptEffect,
          EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
  };
  ...
  class spell_warl_ritual_of_doom_effect_SpellScript : public SpellScript {
    ...
    void Register() override {
      OnEffectHit += SpellEffectFn(
          spell_warl_ritual_of_doom_effect_SpellScript::HandleDummy, EFFECT_0,
          SPELL_EFFECT_DUMMY);
    }
  };
  ...
  class spell_warl_seed_of_corruption_SpellScript : public SpellScript {
    ...
    void Register() override {
      OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
          spell_warl_seed_of_corruption_SpellScript::FilterTargets, EFFECT_0,
...
public:
  ...
  class spell_warl_soulshatter_SpellScript : public SpellScript {
    ...
    void Register() override {
      OnEffectHitTarget +=
          SpellEffectFn(spell_warl_soulshatter_SpellScript::HandleDummy,
  ...
  class spell_warl_siphon_life_AuraScript : public AuraScript {
    ...
    bool Validate(SpellInfo const * /*spellInfo*/) override {
      return ValidateSpellInfo(
          {SPELL_WARLOCK_SIPHON_LIFE_HEAL, SPELL_WARLOCK_GLYPH_OF_SIPHON_LIFE});
    }
    ...
    void OnProc(AuraEffect const *aurEff, ProcEventInfo &eventInfo) {
      ...
      int32 amount = int32(CalculatePct(eventInfo.GetDamageInfo()->GetDamage(),
                                        aurEff->GetAmount()));
      ...
      GetTarget()->CastCustomSpell(SPELL_WARLOCK_SIPHON_LIFE_HEAL,
                                   SPELLVALUE_BASE_POINT0, amount, GetTarget(),
                                   true, nullptr, aurEff);
    }

    void Register() override {
      DoCheckProc +=
          AuraCheckProcFn(spell_warl_siphon_life_AuraScript::CheckProc);
      OnEffectProc +=
          AuraEffectProcFn(spell_warl_siphon_life_AuraScript::OnProc, EFFECT_0,
                           SPELL_AURA_DUMMY);
    }
  };
...
public:
  ...
  class spell_warl_life_tap_SpellScript : public SpellScript {
    ...
    bool Validate(SpellInfo const * /*spell*/) override {
      return ValidateSpellInfo(
          {SPELL_WARLOCK_LIFE_TAP_ENERGIZE, SPELL_WARLOCK_LIFE_TAP_ENERGIZE_2});
    }
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/) {
      ...
      if (Unit *target = GetHitUnit()) {
        ...
        int32 mana =
            int32(damage2Mana +
                  (caster->GetInt32Value(PLAYER_FIELD_MOD_DAMAGE_DONE_POS +
                                         SPELL_SCHOOL_SHADOW) *
                   0.5f));
        ...
        caster->CastCustomSpell(target, SPELL_WARLOCK_LIFE_TAP_ENERGIZE, &mana,
                                nullptr, nullptr, false);

        // Mana Feed
        int32 manaFeedVal = 0;
        if (AuraEffect const *aurEff = caster->GetAuraEffect(
                SPELL_AURA_ADD_FLAT_MODIFIER, SPELLFAMILY_WARLOCK,
                WARLOCK_ICON_ID_MANA_FEED, 0))
          manaFeedVal = aurEff->GetAmount();

        if (manaFeedVal > 0) {
          ApplyPct(manaFeedVal, mana);
          caster->CastCustomSpell(caster, SPELL_WARLOCK_LIFE_TAP_ENERGIZE_2,
                                  &manaFeedVal, nullptr, nullptr, true,
                                  nullptr);
        }
      }
    }
    ...
    SpellCastResult CheckCast() {
      if ((int32(GetCaster()->GetHealth()) >
           int32(GetSpellInfo()->Effects[EFFECT_0].CalcValue() +
                 (3.1 * GetSpellInfo()->BaseLevel) + LIFE_TAP_COEFFICIENT)))
        return SPELL_CAST_OK;
    ...
    void Register() override {
      OnEffectHitTarget +=
          SpellEffectFn(spell_warl_life_tap_SpellScript::HandleDummy, EFFECT_0,
                        SPELL_EFFECT_DUMMY);
      OnCheckCast +=
          SpellCheckCastFn(spell_warl_life_tap_SpellScript::CheckCast);
    }
  };
  ...
  class spell_warl_demonic_circle_summon_AuraScript : public AuraScript {
    ...
    void HandleDummyTick(AuraEffect const * /*aurEff*/) {
      if (GameObject *circle = GetTarget()->GetGameObject(GetId())) {
        // Here we check if player is in demonic circle teleport range, if so
        // add WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST; allowing him to cast the
        // WARLOCK_DEMONIC_CIRCLE_TELEPORT. If not in range remove the
        // WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST.

        SpellInfo const *spellInfo =
            sSpellMgr->GetSpellInfo(SPELL_WARLOCK_DEMONIC_CIRCLE_TELEPORT);

        if (GetTarget()->IsWithinDist(circle, spellInfo->GetMaxRange(true))) {
          if (!GetTarget()->HasAura(SPELL_WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST))
            GetTarget()->CastSpell(
                GetTarget(), SPELL_WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST, true);
        } else
          GetTarget()->RemoveAura(SPELL_WARLOCK_DEMONIC_CIRCLE_ALLOW_CAST);
      }
    }
    ...
    void Register() override {
      OnEffectRemove += AuraEffectRemoveFn(
          spell_warl_demonic_circle_summon_AuraScript::HandleRemove, EFFECT_0,
          SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
      OnEffectPeriodic += AuraEffectPeriodicFn(
          spell_warl_demonic_circle_summon_AuraScript::HandleDummyTick,
...
public:
  ...
  class spell_warl_demonic_circle_teleport_AuraScript : public AuraScript {
    ...
    void HandleTeleport(AuraEffect const * /*aurEff*/,
      ...
      if (Player *player = GetTarget()->ToPlayer()) {
        if (GameObject *circle =
                player->GetGameObject(SPELL_WARLOCK_DEMONIC_CIRCLE_SUMMON)) {
          player->NearTeleportTo(circle->GetPositionX(), circle->GetPositionY(),
                                 circle->GetPositionZ(),
                                 circle->GetOrientation(), false, false, false,
                                 true);
    ...
    void Register() override {
      OnEffectApply += AuraEffectApplyFn(
          spell_warl_demonic_circle_teleport_AuraScript::HandleTeleport,
          EFFECT_0, SPELL_AURA_MECHANIC_IMMUNITY, AURA_EFFECT_HANDLE_REAL);
    }
  };
...
public:
  ...
  class spell_warl_fel_synergy_AuraScript : public AuraScript {
    ...
    void OnProc(AuraEffect const *aurEff, ProcEventInfo &eventInfo) {
      ...
      int32 heal = CalculatePct(int32(eventInfo.GetDamageInfo()->GetDamage()),
                                aurEff->GetAmount());
      GetTarget()->CastCustomSpell(
          SPELL_WARLOCK_FEL_SYNERGY_HEAL, SPELLVALUE_BASE_POINT0, heal,
          (Unit *)nullptr, true, nullptr, aurEff); // TARGET_UNIT_PET
    }

    void Register() override {
      DoCheckProc +=
          AuraCheckProcFn(spell_warl_fel_synergy_AuraScript::CheckProc);
      OnEffectProc +=
          AuraEffectProcFn(spell_warl_fel_synergy_AuraScript::OnProc, EFFECT_0,
                           SPELL_AURA_DUMMY);
    }
  };
  ...
  class spell_warl_haunt_AuraScript : public AuraScript {
    ...
    void HandleRemove(AuraEffect const *aurEff,
      ...
      if (Unit *caster = GetCaster()) {
        ...
        GetTarget()->CastCustomSpell(caster, SPELL_WARLOCK_HAUNT_HEAL, &amount,
    ...
    void Register() override {
      OnEffectRemove += AuraEffectRemoveFn(
          spell_warl_haunt_AuraScript::HandleRemove, EFFECT_1, SPELL_AURA_DUMMY,
...
public:
  ...
  class spell_warl_unstable_affliction_AuraScript : public AuraScript {
      ...
      if (Unit *caster = GetCaster())
        if (AuraEffect const *aurEff = GetEffect(EFFECT_0)) {
          ...
          caster->CastCustomSpell(dispelInfo->GetDispeller(),
                                  ...
                                  &damage, nullptr, nullptr, true, nullptr,
                                  aurEff);
        }
    }
    ...
    void Register() override {
      AfterDispel +=
          AuraDispelFn(spell_warl_unstable_affliction_AuraScript::HandleDispel);
    }
  };
  ...
  class spell_warl_curse_of_doom_AuraScript : public AuraScript {
    ...
    void OnRemove(AuraEffect const *aurEff, AuraEffectHandleModes /*mode*/) {
      ...
      if (GetCaster()->ToPlayer()->isHonorOrXPTarget(GetTarget()))
        GetCaster()->CastSpell(GetTarget(), SPELL_WARLOCK_CURSE_OF_DOOM_EFFECT,
                               true, nullptr, aurEff);
    }

    void Register() override {
      AfterEffectRemove += AuraEffectRemoveFn(
          spell_warl_curse_of_doom_AuraScript::OnRemove, EFFECT_0,
  ...
  class spell_warl_health_funnel_AuraScript : public AuraScript {
    ...
    void ApplyEffect(AuraEffect const * /*aurEff*/,
      ...
      if (caster->HasAura(SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_R2))
        target->CastSpell(target, SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_BUFF_R2,
                          true);
      else if (caster->HasAura(SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_R1))
        target->CastSpell(target, SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_BUFF_R1,
                          true);
    }
    ...
    void Register() override {
      OnEffectRemove += AuraEffectRemoveFn(
          spell_warl_health_funnel_AuraScript::RemoveEffect, EFFECT_0,
          SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
      OnEffectApply += AuraEffectApplyFn(
          spell_warl_health_funnel_AuraScript::ApplyEffect, EFFECT_0,
          SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
    }
  };
  ...
  class spell_warl_shadow_ward_AuraScript : public AuraScript {
    ...
    void CalculateAmount(AuraEffect const * /*aurEff*/, int32 &amount,
      ...
      if (Unit *caster = GetCaster()) {
        ...
        bonus *=
            caster->SpellBaseDamageBonusDone(GetSpellInfo()->GetSchoolMask());
    ...
    void Register() override {
      DoEffectCalcAmount += AuraEffectCalcAmountFn(
          spell_warl_shadow_ward_AuraScript::CalculateAmount, EFFECT_0,
...
public:
  spell_warl_glyph_of_shadowflame()
      : SpellScriptLoader("spell_warl_glyph_of_shadowflame") {}
  ...
  class spell_warl_glyph_of_shadowflame_AuraScript : public AuraScript {
    ...
    void HandleProc(AuraEffect const *aurEff, ProcEventInfo &eventInfo) {
      ...
      GetTarget()->CastSpell(eventInfo.GetProcTarget(),
                             SPELL_WARLOCK_GLYPH_OF_SHADOWFLAME, true, nullptr,
                             aurEff);
    }

    void Register() override {
      OnEffectProc += AuraEffectProcFn(
          spell_warl_glyph_of_shadowflame_AuraScript::HandleProc, EFFECT_0,
          SPELL_AURA_DUMMY);
    }
  };
