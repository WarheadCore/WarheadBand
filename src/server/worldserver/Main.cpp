...
char serviceDescription[] =
    "WarheadCore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char **argv) {
  ...
  std::string configFile =
      sConfigMgr->GetConfigPath() + std::string(_ACORE_CORE_CONFIG);
  int c = 1;
  while (c < argc) {
  ...
  ///- and run the 'Master'
  /// @todo Why do we need this 'Master'? Can't all of this be in the Main as
  /// for Realmd?
  int ret = sMaster->Run();
