...
char serviceName[] = "NodePvP";
char serviceLongName[] = "WarheadCore Node PvP service";
char serviceDescription[] = "WarheadCore World of Warcraft emulator Node PvP service";
/*
...
#define _WARHEAD_NODE_CONFIG "node_pvp.conf"
#endif
...
int main(int argc, char** argv)
{
    ...
    LOG_INFO("server", "{} (node_pvp) ready...", GitRevision::GetFullVersion());
