    ...
    if (GetStatus() == STATUS_IN_PROGRESS)
    {
        ...
        switch (_bgEvents.ExecuteEvent())
        {
            ...
            case BG_WS_EVENT_RESPAWN_BOTH_FLAGS:
                ...
                Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_F_PLACED, CHAT_MSG_BG_SYSTEM_NEUTRAL);
...
void BattlegroundWS::RespawnFlagAfterDrop(TeamId teamId)
{
    ...
    Warhead::Text::SendBattlegroundMessageToAll(this, teamId == TEAM_ALLIANCE ? LANG_BG_WS_ALLIANCE_FLAG_RESPAWNED : LANG_BG_WS_HORDE_FLAG_RESPAWNED, CHAT_MSG_BG_SYSTEM_NEUTRAL);
    PlaySoundToAll(BG_WS_SOUND_FLAGS_RESPAWNED);
...
void BattlegroundWS::EventPlayerCapturedFlag(Player* player)
{
    ...
    if (player->GetTeamId() == TEAM_ALLIANCE)
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_CAPTURED_HF, CHAT_MSG_BG_SYSTEM_ALLIANCE, player);
    ...
    else
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_CAPTURED_AF, CHAT_MSG_BG_SYSTEM_HORDE, player);
...
void BattlegroundWS::EventPlayerDroppedFlag(Player* player)
{
    ...
    if (player->GetTeamId() == TEAM_ALLIANCE)
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_DROPPED_HF, CHAT_MSG_BG_SYSTEM_HORDE, player);
    ...
    else
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_DROPPED_AF, CHAT_MSG_BG_SYSTEM_ALLIANCE, player);
...
void BattlegroundWS::EventPlayerClickedOnFlag(Player* player, GameObject* gameObject)
{
    ...
    if (player->GetTeamId() == TEAM_HORDE && GetFlagState(TEAM_ALLIANCE) == BG_WS_FLAG_STATE_ON_BASE && BgObjects[BG_WS_OBJECT_A_FLAG] == gameObject->GetGUID())
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_PICKEDUP_AF, CHAT_MSG_BG_SYSTEM_HORDE, player);
    ...
    if (player->GetTeamId() == TEAM_ALLIANCE && GetFlagState(TEAM_HORDE) == BG_WS_FLAG_STATE_ON_BASE && BgObjects[BG_WS_OBJECT_H_FLAG] == gameObject->GetGUID())
    {
        ...
        Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_PICKEDUP_HF, CHAT_MSG_BG_SYSTEM_ALLIANCE, player);
    ...
    if (GetFlagState(TEAM_ALLIANCE) == BG_WS_FLAG_STATE_ON_GROUND && player->IsWithinDistInMap(gameObject, 10.0f) && gameObject->GetEntry() == BG_OBJECT_A_FLAG_GROUND_WS_ENTRY)
    {
        ...
        if (player->GetTeamId() == TEAM_ALLIANCE)
        {
            ...
            Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_RETURNED_AF, CHAT_MSG_BG_SYSTEM_ALLIANCE, player);
            _bgEvents.CancelEvent(BG_WS_EVENT_BOTH_FLAGS_KEPT10);
            _bgEvents.CancelEvent(BG_WS_EVENT_BOTH_FLAGS_KEPT15);
            RemoveAssaultAuras();
    ...
    if (GetFlagState(TEAM_HORDE) == BG_WS_FLAG_STATE_ON_GROUND && player->IsWithinDistInMap(gameObject, 10.0f) && gameObject->GetEntry() == BG_OBJECT_H_FLAG_GROUND_WS_ENTRY)
    {
        ...
        if (player->GetTeamId() == TEAM_HORDE)
        {
            ...
            PlaySoundToAll(BG_WS_SOUND_FLAG_RETURNED);
            Warhead::Text::SendBattlegroundMessageToAll(this, LANG_BG_WS_RETURNED_HF, CHAT_MSG_BG_SYSTEM_HORDE, player);
            _bgEvents.CancelEvent(BG_WS_EVENT_BOTH_FLAGS_KEPT10);
            _bgEvents.CancelEvent(BG_WS_EVENT_BOTH_FLAGS_KEPT15);
            RemoveAssaultAuras();
...
bool BattlegroundWS::SetupBattleground()
{
    ...
    // buffs
    AddObject(BG_WS_OBJECT_SPEEDBUFF_1, BG_OBJECTID_SPEEDBUFF_ENTRY, 1449.93f, 1470.71f, 342.6346f, -1.64061f, 0, 0, 0.7313537f, -0.6819983f, CONF_GET_INT("Battleground.BuffRespawn"));
    AddObject(BG_WS_OBJECT_SPEEDBUFF_2, BG_OBJECTID_SPEEDBUFF_ENTRY, 1005.171f, 1447.946f, 335.9032f, 1.64061f, 0, 0, 0.7313537f, 0.6819984f, CONF_GET_INT("Battleground.BuffRespawn"));
    AddObject(BG_WS_OBJECT_REGENBUFF_1, BG_OBJECTID_REGENBUFF_ENTRY, 1317.506f, 1550.851f, 313.2344f, -0.2617996f, 0, 0, 0.1305263f, -0.9914448f, CONF_GET_INT("Battleground.BuffRespawn"));
    AddObject(BG_WS_OBJECT_REGENBUFF_2, BG_OBJECTID_REGENBUFF_ENTRY, 1110.451f, 1353.656f, 316.5181f, -0.6806787f, 0, 0, 0.333807f, -0.9426414f, CONF_GET_INT("Battleground.BuffRespawn"));
    AddObject(BG_WS_OBJECT_BERSERKBUFF_1, BG_OBJECTID_BERSERKERBUFF_ENTRY, 1320.09f, 1378.79f, 314.7532f, 1.186824f, 0, 0, 0.5591929f, 0.8290376f, CONF_GET_INT("Battleground.BuffRespawn"));
    AddObject(BG_WS_OBJECT_BERSERKBUFF_2, BG_OBJECTID_BERSERKERBUFF_ENTRY, 1139.688f, 1560.288f, 306.8432f, -2.443461f, 0, 0, 0.9396926f, -0.3420201f, CONF_GET_INT("Battleground.BuffRespawn"));
    // alliance gates
