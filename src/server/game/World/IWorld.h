...
struct CliCommandHolder {
  ...
  CliCommandHolder(void *callbackArg, const char *command, Print *zprint,
...
public:
  ...
  FindOfflineSessionForCharacterGUID(uint32 guidLow) const = 0;
  ...
  virtual void SendGlobalMessage(WorldPacket *packet,
                                 WorldSession *self = nullptr,
                                 TeamId teamId = TEAM_NEUTRAL) = 0;
  virtual void SendGlobalGMMessage(WorldPacket *packet,
                                   WorldSession *self = nullptr,
                                   TeamId teamId = TEAM_NEUTRAL) = 0;
  virtual bool SendZoneMessage(uint32 zone, WorldPacket *packet,
                               WorldSession *self = nullptr,
                               TeamId teamId = TEAM_NEUTRAL) = 0;
  virtual void SendZoneText(uint32 zone, const char *text,
                            WorldSession *self = nullptr,
                            TeamId teamId = TEAM_NEUTRAL) = 0;
  virtual void SendServerMessage(ServerMessageType type, const char *text = "",
  ...
  virtual void AddGlobalPlayerData(uint32 guid, uint32 accountId,
                                   std::string const &name, uint8 gender,
                                   uint8 race, uint8 playerClass, uint8 level,
                                   uint16 mailCount, uint32 guildId) = 0;
  virtual void UpdateGlobalPlayerData(uint32 guid, uint8 mask,
                                      std::string const &name, uint8 level = 0,
                                      uint8 gender = 0, uint8 race = 0,
                                      uint8 playerClass = 0) = 0;
  virtual void UpdateGlobalPlayerMails(uint32 guid, int16 count,
                                       bool add = true) = 0;
  ...
  virtual void UpdateGlobalPlayerArenaTeam(uint32 guid, uint8 slot,
                                           uint32 arenaTeamId) = 0;
  virtual void UpdateGlobalNameData(uint32 guidLow, std::string const &oldName,
