...
bool Unit::Attack(Unit* victim, bool meleeAttack)
{
    ...
    if (creature && !(IsControllableGuardian() && IsControlledByPlayer()))
    {
        ...
        creature->SetAssistanceTimer(CONF_GET_UINT("CreatureFamilyAssistancePeriod"));
...
void Unit::SetContestedPvP(Player* attackedPlayer, bool lookForNearContestedGuards)
{
    ...
    {
        std::list<Unit*> targets;
        Warhead::NearestVisibleDetectableContestedGuardUnitCheck u_check(this);
        Warhead::UnitListSearcher<Warhead::NearestVisibleDetectableContestedGuardUnitCheck> searcher(this, targets, u_check);
