...
namespace Warhead::Impl::ChatCommands
{
    ...
    struct CommandPermissions
    {
        ...
        CommandPermissions(uint32 securityLevel, Warhead::ChatCommands::Console console) : RequiredLevel{ securityLevel }, AllowConsole{ console } {}
    ...
    private:
        ...
        static void LoadCommandsIntoMap(ChatCommandNode* blank, std::map<std::string_view, Warhead::Impl::ChatCommands::ChatCommandNode, StringCompareLessI_T>& map, Warhead::ChatCommands::ChatCommandTable const& commands);
