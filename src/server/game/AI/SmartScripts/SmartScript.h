...
public:
  ...
  void ProcessEventsFor(SMART_EVENT e, Unit *unit = nullptr, uint32 var0 = 0,
                        uint32 var1 = 0, bool bvar = false,
                        const SpellInfo *spell = nullptr,
                        GameObject *gob = nullptr);
  void ProcessEvent(SmartScriptHolder &e, Unit *unit = nullptr, uint32 var0 = 0,
                    uint32 var1 = 0, bool bvar = false,
                    const SpellInfo *spell = nullptr,
                    GameObject *gob = nullptr);
  ...
  void ProcessAction(SmartScriptHolder &e, Unit *unit = nullptr,
                     ...
                     const SpellInfo *spell = nullptr,
                     GameObject *gob = nullptr);
  void ProcessTimedAction(SmartScriptHolder &e, uint32 const &min,
                          uint32 const &max, Unit *unit = nullptr,
                          uint32 var0 = 0, uint32 var1 = 0, bool bvar = false,
                          const SpellInfo *spell = nullptr,
                          GameObject *gob = nullptr);
  ...
  SmartScriptHolder CreateSmartEvent(SMART_EVENT e, uint32 event_flags,
  ...
  void AddEvent(SMART_EVENT e, uint32 event_flags, uint32 event_param1,
                ...
                uint32 event_param5, SMART_ACTION action, uint32 action_param1,
                uint32 action_param2, uint32 action_param3,
                uint32 action_param4, uint32 action_param5,
  ...
  void DoFindFriendlyMissingBuff(std::list<Creature *> &list, float range,
                                 uint32 spellid);
  ...
  GameObject *FindGameObjectNear(WorldObject *searchObject, uint32 guid) const {
    ...
    cell.Visit(p, objectChecker, *searchObject->GetMap(), *searchObject,
               searchObject->GetVisibilityRange());
  ...
  Creature *FindCreatureNear(WorldObject *searchObject, uint32 guid) const {
    ...
    Warhead::CreatureSearcher<Warhead::CreatureWithDbGUIDCheck> checker(
        searchObject, creature, target_check);

    TypeContainerVisitor<
        Warhead::CreatureSearcher<Warhead::CreatureWithDbGUIDCheck>,
        GridTypeMapContainer>
        unit_checker(checker);
    cell.Visit(p, unit_checker, *searchObject->GetMap(), *searchObject,
               searchObject->GetVisibilityRange());
