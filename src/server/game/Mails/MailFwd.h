...
#ifndef WARHEAD_MAIL_FWD_H_
#define WARHEAD_MAIL_FWD_H_

#include "Define.h"

constexpr auto MAIL_BODY_ITEM_TEMPLATE = 8383; // - plain letter, A Dusty Unsent Letter: 889
constexpr auto MAX_MAIL_ITEMS = 12;
