...
template class WH_GAME_API ScriptRegistry<__script_object>; \
template class WH_GAME_API SpecializedScriptRegistry<__script_object, is_script_database_bound<__script_object>::value>;
