...
bool ScriptMgr::OnGossipHello(Player* player, Creature* creature)
{
    ...
    auto tempScript = sScriptRegistryMgr(CreatureScript)->GetScriptById(creature->GetScriptId());
...
void ScriptMgr::OnCreatureUpdate(Creature* creature, uint32 diff)
{
    ...
    if (auto tempScript = sScriptRegistryMgr(CreatureScript)->GetScriptById(creature->GetScriptId()))
    {
