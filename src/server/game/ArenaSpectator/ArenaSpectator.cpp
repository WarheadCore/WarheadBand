...
namespace ArenaSpectator
{
    ...
    void CreatePacket(WorldPacket& data, std::string const& message)
    {
    ...
    template<>
    WH_GAME_API void SendPacketTo(const Player* player, std::string&& message)
    {
        WorldPacket data;
    ...
    template<>
    WH_GAME_API void SendPacketTo(const Map* map, std::string&& message)
    {
