...
namespace WorldPackets::Misc
{
    ...
    class WH_GAME_API LevelUpInfo final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API RandomRollClient final : public ClientPacket
    {
    public:
    ...
    class WH_GAME_API RandomRoll final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API StartMirrorTimer final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API PauseMirrorTimer final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API StopMirrorTimer final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API DurabilityDamageDeath final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API CrossedInebriationThreshold final : public ServerPacket
    {
    public:
    ...
    class WH_GAME_API UITime final : public ServerPacket
    {
    public:
