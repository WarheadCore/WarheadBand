...
void WardenMac::Init(WorldSession *pClient, SessionKey const &K) {
  ...
  New Cerver Key: <?>
  */
  uint8 mod_seed[16] = {0x4D, 0x80, 0x8D, 0x2C, 0x77, 0xD9, 0x05, 0xC4,
...
ClientWardenModule *WardenMac::GetModuleForClient() {
  ...
  memcpy(mod->CompressedData, Module_0DBBF209A27B1E279A9FEC5C168A15F7_Data,
         len);
...
void WardenMac::HandleHashResult(ByteBuffer &buff) {
  ...
  keyData mod_seed = {{{{0x4D, 0x80, 0x8D, 0x2C, 0x77, 0xD9, 0x05, 0xC4, 0x1A,
  ...
  // 0x2A, 0x60, 0x37, 0xA2, 0x29, 0x0C, 0x22, 0xB5, 0x25, 0x71, 0xA0, 0x6F, 0x4E
  // };
