...
public:
  ...
  [[nodiscard]] uint8 GetUInt8() const {
    ...
    if (!IsType(MYSQL_TYPE_TINY)) {
      LOG_INFO("sql.driver",
               "Warning: GetUInt8() on non-tinyint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] int8 GetInt8() const {
    ...
    if (!IsType(MYSQL_TYPE_TINY)) {
      LOG_INFO("sql.driver",
               "Warning: GetInt8() on non-tinyint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
...
#ifdef ELUNA
  enum_field_types GetType() const { return data.type; }
#endif
  ...
  [[nodiscard]] uint16 GetUInt16() const {
    ...
    if (!IsType(MYSQL_TYPE_SHORT) && !IsType(MYSQL_TYPE_YEAR)) {
      LOG_INFO("sql.driver",
               "Warning: GetUInt16() on non-smallint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] int16 GetInt16() const {
    ...
    if (!IsType(MYSQL_TYPE_SHORT) && !IsType(MYSQL_TYPE_YEAR)) {
      LOG_INFO("sql.driver",
               "Warning: GetInt16() on non-smallint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] uint32 GetUInt32() const {
    ...
    if (!IsType(MYSQL_TYPE_INT24) && !IsType(MYSQL_TYPE_LONG)) {
      LOG_INFO("sql.driver",
               "Warning: GetUInt32() on non-(medium)int field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] int32 GetInt32() const {
    ...
    if (!IsType(MYSQL_TYPE_INT24) && !IsType(MYSQL_TYPE_LONG)) {
      LOG_INFO("sql.driver",
               "Warning: GetInt32() on non-(medium)int field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] uint64 GetUInt64() const {
    ...
    if (!IsType(MYSQL_TYPE_LONGLONG) && !IsType(MYSQL_TYPE_BIT)) {
      LOG_INFO("sql.driver",
               "Warning: GetUInt64() on non-bigint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] int64 GetInt64() const {
    ...
    if (!IsType(MYSQL_TYPE_LONGLONG) && !IsType(MYSQL_TYPE_BIT)) {
      LOG_INFO("sql.driver",
               "Warning: GetInt64() on non-bigint field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0;
    }
#endif
  ...
  [[nodiscard]] float GetFloat() const {
    ...
    if (!IsType(MYSQL_TYPE_FLOAT)) {
      LOG_INFO("sql.driver",
               "Warning: GetFloat() on non-float field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0.0f;
    }
#endif
  ...
  [[nodiscard]] double GetDouble() const {
    ...
    if (!IsType(MYSQL_TYPE_DOUBLE)) {
      LOG_INFO("sql.driver",
               "Warning: GetDouble() on non-double field. Using type: %s.",
               FieldTypeToString(data.type));
      return 0.0f;
    }
#endif
  ...
  [[nodiscard]] char const *GetCString() const {
    ...
    if (IsNumeric()) {
      LOG_INFO("sql.driver",
               "Error: GetCString() on numeric field. Using type: %s.",
               FieldTypeToString(data.type));
      return nullptr;
    }
#endif
  ...
  [[nodiscard]] bool IsNull() const { return data.value == nullptr; }

  [[nodiscard]] std::vector<uint8> GetBinary() const;
  template <size_t S>[[nodiscard]] std::array<uint8, S> GetBinary() const {
...
#pragma pack(pop)
  ...
  void SetByteValue(void const *newValue, size_t const newSize,
  ...
  static size_t SizeForType(MYSQL_FIELD *field) {
    ...
    */
    default:
      LOG_INFO("sql.driver", "SQL::SizeForType(): invalid field type %u",
               uint32(field->type));
      return 0;
    }
  }
  ...
  [[nodiscard]] bool IsNumeric() const {
    return (data.type == MYSQL_TYPE_TINY || data.type == MYSQL_TYPE_SHORT ||
            ...
            data.type == MYSQL_TYPE_FLOAT || data.type == MYSQL_TYPE_DOUBLE ||
