...
namespace Warhead
{
    ...
    [[noreturn]] WH_COMMON_API void Assert(char const* file, int line, char const* function, std::string const& debugInfo, std::string_view fmt, Args&&... args);

    template<typename... Args>
    [[noreturn]] WH_COMMON_API void Fatal(char const* file, int line, char const* function, std::string_view fmt, Args&&... args);

    template<typename... Args>
    [[noreturn]] WH_COMMON_API void Error(char const* file, int line, char const* function, std::string_view fmt, Args&&... args);

    [[noreturn]] WH_COMMON_API void Abort(char const* file, int line, char const* function);

    template<typename... Args>
    [[noreturn]] WH_COMMON_API void Abort(char const* file, int line, char const* function, std::string_view fmt, Args&&... args);

    template<typename... Args>
    WH_COMMON_API void Warning(char const* file, int line, char const* function, std::string_view fmt, Args&&... args);
