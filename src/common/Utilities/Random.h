...
WH_COMMON_API uint32 urandms(uint32 min, uint32 max);
...
WH_COMMON_API uint32 urandweighted(std::size_t count, double const* chances);
...
*/
class WH_COMMON_API RandomEngine
{
public:
