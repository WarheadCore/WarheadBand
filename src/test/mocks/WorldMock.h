...
public:
  ...
  MOCK_METHOD(WorldSession *, FindOfflineSessionForCharacterGUID,
              (uint32 guidLow), (const));
  ...
  MOCK_METHOD(void, SendGlobalMessage,
              (WorldPacket * packet, WorldSession *self, TeamId teamId), ());
  MOCK_METHOD(void, SendGlobalGMMessage,
              (WorldPacket * packet, WorldSession *self, TeamId teamId), ());
  MOCK_METHOD(bool, SendZoneMessage,
              (uint32 zone, WorldPacket *packet, WorldSession *self,
               TeamId teamId),
              ());
  MOCK_METHOD(void, SendZoneText,
              (uint32 zone, const char *text, WorldSession *self,
               TeamId teamId),
              ());
  ...
  MOCK_METHOD(GlobalPlayerData const *, GetGlobalPlayerData, (uint32 guid),
              (const));
  MOCK_METHOD(void, AddGlobalPlayerData,
              (uint32 guid, uint32 accountId, std::string const &name,
               uint8 gender, uint8 race, uint8 playerClass, uint8 level,
               uint16 mailCount, uint32 guildId),
              ());
  MOCK_METHOD(void, UpdateGlobalPlayerData,
              (uint32 guid, uint8 mask, std::string const &name, uint8 level,
               uint8 gender, uint8 race, uint8 playerClass),
              ());
  MOCK_METHOD(void, UpdateGlobalPlayerMails,
              (uint32 guid, int16 count, bool add), ());
  ...
  MOCK_METHOD(void, UpdateGlobalPlayerArenaTeam,
              (uint32 guid, uint8 slot, uint32 arenaTeamId), ());
  MOCK_METHOD(void, UpdateGlobalNameData,
              (uint32 guidLow, std::string const &oldName,
               std::string const &newName),
              ());
  MOCK_METHOD(void, DeleteGlobalPlayerData,
              (uint32 guid, std::string const &name), ());
  ...
  MOCK_METHOD(LocaleConstant, GetAvailableDbcLocale, (LocaleConstant locale),
              (const));
